...
// ============================================================
// Iterated domain warping (Inigo Quilez): fbm(p + fbm(p + fbm(p))).
// This is what turns flat noise into marbled, poured-paint structure.
// q and r are handed back so the color ramp can key off the same
// fields that shaped the geometry — veins land on real features.
// ============================================================
