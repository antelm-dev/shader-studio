...
describe('readImageDimensions', () => {
  it('reads a PNG IHDR chunk', () => {
    const png = bytes(
      ...
      0x08, 0x06, 0x00, 0x00, 0x00, // rest of IHDR (unused)
    );
  ...
  it('reads a baseline JPEG SOF0 marker', () => {
    const jpeg = bytes(
      0xff, 0xd8, // SOI
      0xff, 0xe0, 0x00, 0x10, ...new Array(14).fill(0), // APP0 segment, length 16
      0xff, 0xc0, // SOF0
  ...
  it('reads a VP8X (extended) WebP header', () => {
    const webp = bytes(
      ...
      0x1f, 0x00, 0x00, // width - 1 = 31 -> width 32
      0x0f, 0x00, 0x00, // height - 1 = 15 -> height 16
    );
